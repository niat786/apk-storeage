...
class TxtSvgIcon extends Component
{
    public function render()
    {
        return <<<'blade'
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-txt" viewBox="0 0 16 16">
        ...
        // return view('livewire.txt-svg-icon');
    }
}
