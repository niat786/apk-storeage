                                ...
                                @forelse ($uploaded_file as $file)
                                    <div class="p-4 mx-4 border border-dashed rounded-lg ">
                                        ...
                                        <div class="container my-2" x-data="{ copied: 0 }">
                                            <p for="d-link"><span id="copy-message" x-transition
                                                    class="hidden w-full text-xs text-green-600">Link Copied!</span>
                                            </p>
                                            <div class="group">
                                                ...
                                                <input id="d-link" type="url" class="input-field"
                                                    value="{{ $link }}">
                                            </div>
                                            <div class="group">
