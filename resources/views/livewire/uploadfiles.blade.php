<div class="container max-w-6xl mx-auto my-12 overflow-hidden rounded-lg shadow-lg">
    ...
    <div class="flex justify-start p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex items-center mt-4 text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-violet-600">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                class="text-pink-600" viewBox="0 0 16 16">
    ...
    <div class="grid grid-cols-1 bg-gray-100 bg-opacity-25 md:grid-cols-2">
        <div class="p-6 ">
    ...
    <div class="flex justify-start p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex items-center mt-4 text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-violet-600">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-pink-600"
                viewBox="0 0 16 16">
