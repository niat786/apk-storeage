            ...
            <div class="p-6 bg-white border-b border-gray-200 sm:px-20">
                ...
                <div class="mt-6 text-gray-500">
                    ...
                    <div class="my-6">
                        ...
                        <div class="p-5 my-4 text-green-600 bg-green-100 rounded">


                        <p>Please make sure that we do not delete files from your backblaze account.</p>
                        <p>If you still want to delete files from your account then you can delete them manually.</p>
                    </div>
                    </div>
                </div>
            </div>
