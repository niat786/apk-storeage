...
<div class="container pt-4 pb-10 mx-auto my-5 bg-white rounded shadow-lg">
    ...
    <div class="flex flex-col items-center gap-5">
        <div class="p-10">
           <p class="text-centers"> There might be a link to download the document "<span class="text-orange-600">{{$f}}</span>". You can download the file by creating a legitimate download link. <br>By doing these things, you can acquire the link.</p>
    ...
    <p>Downloa the file for offline usage.</p>
        ...
        <div class="flex items-center cursor-pointer downloadbtn button" id="d-btn">
            <svg xmlns="http://www.w3.org/2000/svg" id="spinner" width="16" height="16" fill="currentColor" class="" viewBox="0 0 16 16">
