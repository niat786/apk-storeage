...
@section('content')
    ...
    @else
        <div class="container pt-4 pb-10 mx-auto my-5 bg-white rounded shadow-lg">
            ...
            @endif
            <div class="flex justify-center py-5 title">
                <h1 class="text-2xl text-orange-600">Your File "{{ $f }}" is ready to download</h1>

            </div>
            <div class="flex flex-col items-center gap-5">
                <p>You have successfully created a download link for this file. This link is valid for several hours.</p>
